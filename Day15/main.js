...
var _avh4$elm_fifo$Fifo$insert = F2(
	function (a, _p2) {
		...
		return A2(
			_avh4$elm_fifo$Fifo$Fifo,
			_p3._0,
			A2(_elm_lang$core$List_ops['::'], a, _p3._1));
	});
...
var _user$project$Day14_TileGrid$fold = F2(
...
var _user$project$Day14_TileGrid$inAnimation = function (startTime) {
	return A2(
...
var _user$project$Day14_TileGrid$outAnimation = function (startTime) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		400,
		A2(
...
var _user$project$Day14_TileGrid$viewTile = F3(
	function (now, animation, color) {
		var _p0 = animation;
		if (_p0.ctor === 'Nothing') {
			return A2(
				_evancz$elm_graphics$Collage$filled,
				color,
				_evancz$elm_graphics$Collage$square(60));
		} else {
			var _p1 = _p0._0._0;
			return _evancz$elm_graphics$Collage$group(
				_elm_lang$core$Native_List.fromArray(
					[
						function () {
						var bw = 30 - (7 * _elm_lang$core$Basics$cos(
							_elm_lang$core$Basics$degrees(90) * A2(
								_mgold$elm_animation$Animation$animate,
								now,
								_user$project$Day14_TileGrid$outAnimation(_p1))));
						var fw = 30 + (7 * _elm_lang$core$Basics$cos(
							_elm_lang$core$Basics$degrees(90) * A2(
								_mgold$elm_animation$Animation$animate,
								now,
								_user$project$Day14_TileGrid$outAnimation(_p1))));
						...
						return A2(
							...
							_evancz$elm_graphics$Collage$polygon(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 0 - fw, _1: 0 - h},
										{ctor: '_Tuple2', _0: 0 - bw, _1: h},
										{ctor: '_Tuple2', _0: bw, _1: h},
										{ctor: '_Tuple2', _0: fw, _1: 0 - h}
									])));
					}(),
						function () {
						var bw = 30 + (7 * _elm_lang$core$Basics$cos(
							_elm_lang$core$Basics$degrees(90) * A2(
								_mgold$elm_animation$Animation$animate,
								now,
								_user$project$Day14_TileGrid$inAnimation(_p1))));
						var fw = 30 - (7 * _elm_lang$core$Basics$cos(
							_elm_lang$core$Basics$degrees(90) * A2(
								_mgold$elm_animation$Animation$animate,
								now,
...
var _user$project$Day14_TileGrid$view = F2(
	function (now, _p2) {
		var _p3 = _p2;
		var _p4 = _p3._0;
		var tile = F2(
			function (y, x) {
				return A2(
					...
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$toFloat(x) * 70,
						_1: 0
					},
					A2(
						_elm_lang$core$Maybe$withDefault,
						...
						A2(
							...
							A2(
								_user$project$Day14_TileGrid$viewTile,
								now,
								A2(
									_elm_lang$core$Dict$get,
									{ctor: '_Tuple2', _0: x, _1: y},
									_p4.currentAnimations)),
							A2(
								_elm_lang$core$Dict$get,
								{ctor: '_Tuple2', _0: x, _1: y},
								_p4.tiles))));
			});
		var tileRow = function (y) {
			return A2(
				_evancz$elm_graphics$Collage$move,
				{
					ctor: '_Tuple2',
					_0: 0,
					_1: _elm_lang$core$Basics$toFloat(y) * 70
				},
				_evancz$elm_graphics$Collage$group(
					A2(
						_elm_lang$core$List$map,
...
var _user$project$Day14_TileGrid$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _user$project$Day14_TileGrid$init = function (colors) {
	var colorFor = F2(
		function (x, y) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
	...
	return _user$project$Day14_TileGrid$Model(
		{
			tiles: A2(_user$project$Day14_TileGrid$fold, insertTile, _elm_lang$core$Dict$empty),
			pendingAnimations: _avh4$elm_fifo$Fifo$empty,
			currentAnimations: _elm_lang$core$Dict$empty,
			lastStartTime: 0
		});
};
var _user$project$Day14_TileGrid$startNextTileAnimation = F2(
	function (now, _p5) {
		var _p6 = _p5;
		var _p10 = _p6._0;
		var _p7 = _avh4$elm_fifo$Fifo$remove(_p10.pendingAnimations);
		if (_p7._0.ctor === 'Just') {
			var _p9 = _p7._0._0._0._1;
			var _p8 = _p7._0._0._0._0;
			return A2(
				_elm_lang$core$Dict$member,
				{ctor: '_Tuple2', _0: _p8, _1: _p9},
				_p10.currentAnimations) ? _user$project$Day14_TileGrid$Model(_p10) : _user$project$Day14_TileGrid$Model(
				_elm_lang$core$Native_Utils.update(
					_p10,
					{
						currentAnimations: A3(
							_elm_lang$core$Dict$insert,
							{ctor: '_Tuple2', _0: _p8, _1: _p9},
							{ctor: '_Tuple2', _0: now, _1: _p7._0._0._1},
							_p10.currentAnimations),
						pendingAnimations: _p7._1
					}));
		} else {
			return _user$project$Day14_TileGrid$Model(
				_elm_lang$core$Native_Utils.update(
...
var _user$project$Day14_TileGrid$clearFinishedAnimations = F2(
	function (now, _p11) {
		var _p12 = _p11;
		var _p20 = _p12._0;
		var finalizeColor = F3(
		...
		var isDone = F2(
			function (key, _p17) {
				var _p18 = _p17;
				return A2(
					_mgold$elm_animation$Animation$isDone,
					now,
					_user$project$Day14_TileGrid$inAnimation(_p18._0));
			});
		var _p19 = A2(_elm_lang$core$Dict$partition, isDone, _p20.currentAnimations);
		var finishedAnimations = _p19._0;
		var remainingAnimations = _p19._1;
		return _user$project$Day14_TileGrid$Model(
			_elm_lang$core$Native_Utils.update(
				_p20,
				{
					currentAnimations: remainingAnimations,
					tiles: A3(_elm_lang$core$Dict$foldl, finalizeColor, _p20.tiles, finishedAnimations)
				}));
	});
var _user$project$Day14_TileGrid$startNewAnimations = F2(
	function (now, _p21) {
		var _p22 = _p21;
		var _p23 = _p22._0;
		return (_elm_lang$core$Native_Utils.cmp(_p23.lastStartTime + 100, now) < 0) ? A2(
			_user$project$Day14_TileGrid$startNextTileAnimation,
			now,
			A2(
				_user$project$Day14_TileGrid$startNextTileAnimation,
				now,
				A2(
					_user$project$Day14_TileGrid$startNextTileAnimation,
					now,
					_user$project$Day14_TileGrid$Model(
						_elm_lang$core$Native_Utils.update(
							_p23,
							{lastStartTime: now}))))) : _user$project$Day14_TileGrid$Model(_p23);
	});
var _user$project$Day14_TileGrid$changeColors = F3(
	function (now, newColors, _p24) {
		var _p25 = _p24;
		var _p27 = _p25._0;
		var colorFor = F2(
			function (x, y) {
					...
					_elm_lang$core$List$head(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['%'],
								x + y,
								_elm_lang$core$List$length(newColors)),
							newColors)));
			});
		var newAnimations = A2(
			_user$project$Day14_TileGrid$fold,
			F3(
				function (x, y, acc) {
					return A2(
		...
		var _p26 = A2(
			_elm_lang$core$Random$step,
			_elm_community$random_extra$Random_Array$shuffle(newAnimations),
			_elm_lang$core$Random$initialSeed(
				_elm_lang$core$Basics$floor(now)));
		var shuffledAnimations = _p26._0;
		var newSeed = _p26._1;
		return A2(
			_user$project$Day14_TileGrid$startNewAnimations,
			now,
			_user$project$Day14_TileGrid$Model(
				_elm_lang$core$Native_Utils.update(
					_p27,
					{
						pendingAnimations: A3(_elm_lang$core$Array$foldl, _avh4$elm_fifo$Fifo$insert, _p27.pendingAnimations, shuffledAnimations)
					})));
	});
var _user$project$Day14_TileGrid$update = F2(
	function (now, _p28) {
		var _p29 = _p28;
		return A2(
			_user$project$Day14_TileGrid$startNewAnimations,
			now,
			A2(
				_user$project$Day14_TileGrid$clearFinishedAnimations,
				now,
				_user$project$Day14_TileGrid$Model(_p29._0)));
	});

var _user$project$Main$randomColor = _elm_community$random_extra$Random_Extra$choices(
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$red),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$blue),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$green),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$yellow),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$orange),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$purple),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$charcoal),
			_elm_community$random_extra$Random_Extra$constant(_elm_lang$core$Color$brown)
		]));
var _user$project$Main$initialModel = {
	tileGrid: _user$project$Day14_TileGrid$init(
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$imageSet = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: 'rhino-color.jpg', _1: 'rhino-silhoutte.png'},
		{ctor: '_Tuple2', _0: 'crow-color.jpg', _1: 'crow-silhouette.png'},
		{ctor: '_Tuple2', _0: 'fish-color.jpg', _1: 'fish-silhouette.png'},
		{ctor: '_Tuple2', _0: 'dragon-color.jpg', _1: 'dragon-silhouette.png'},
		{ctor: '_Tuple2', _0: 'quill-color.png', _1: 'quill-silhouette.png'},
		{ctor: '_Tuple2', _0: 'reindeer-color.jpg', _1: 'reindeer-silhouette.png'},
		{ctor: '_Tuple2', _0: 'saxophone-color.jpg', _1: 'saxophone-silhouette.png'},
		{ctor: '_Tuple2', _0: 'stork-color.jpg', _1: 'stork-silhouette.png'},
		{ctor: '_Tuple2', _0: 'tea-color.jpg', _1: 'tea-silhouette.png'},
		{ctor: '_Tuple2', _0: 'swan-color.jpg', _1: 'swan-silhouette.png'},
		{ctor: '_Tuple2', _0: 'unicorn-color.jpg', _1: 'unicorn-silhouette.png'},
		{ctor: '_Tuple2', _0: 'beard-color.jpg', _1: 'beard-silhouette.png'}
	]);
var _user$project$Main$requestImageColors = _elm_lang$core$Native_Platform.outgoingPort(
	'requestImageColors',
	function (v) {
		return v;
	});
var _user$project$Main$imageColorResults = _elm_lang$core$Native_Platform.incomingPort(
	'imageColorResults',
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {tileGrid: a, now: b, colorImage: c, silhouetteImage: d};
	});
var _user$project$Main$ChangeImage = function (a) {
	return {ctor: 'ChangeImage', _0: a};
};
var _user$project$Main$NewImage = function (a) {
	return {ctor: 'NewImage', _0: a};
};
var _user$project$Main$AnalyzedColors = function (a) {
	return {ctor: 'AnalyzedColors', _0: a};
};
var _user$project$Main$ColorImageLoaded = {ctor: 'ColorImageLoaded'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$id('mainImage'),
						_elm_lang$html$Html_Attributes$src(model.colorImage),
						A2(
						_elm_lang$html$Html_Events$on,
						'load',
						_elm_lang$core$Json_Decode$succeed(_user$project$Main$ColorImageLoaded))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(_user$project$Day14_TileGrid$view, model.now, model.tileGrid))
										]))
								])))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
								{ctor: '_Tuple2', _0: 'width', _1: '280px'},
								{ctor: '_Tuple2', _0: 'height', _1: '250px'},
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										{ctor: '_Tuple2', _0: 'top', _1: '50%'},
										{ctor: '_Tuple2', _0: 'left', _1: '50%'},
										{ctor: '_Tuple2', _0: 'object-fit', _1: 'contain'},
										{ctor: '_Tuple2', _0: 'transform', _1: 'translateX(-50%) translateY(-50%)'},
										{ctor: '_Tuple2', _0: 'max-width', _1: '100%'},
										{ctor: '_Tuple2', _0: 'max-height', _1: '100%'},
										{ctor: '_Tuple2', _0: '-webkit-filter', _1: 'drop-shadow(0 0 50px rgba(255,255,255,1.0))'}
									])),
								_elm_lang$html$Html_Attributes$src(model.silhouetteImage),
...
var _user$project$Main$ChangeColors = function (a) {
			...
			switch (_p0.ctor) {
				case 'Tick':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								now: _p1,
								tileGrid: A2(_user$project$Day14_TileGrid$update, _p1, model.tileGrid)
							}),
				...
				case 'NewColors':
					return {
						...
						_1: A2(
							_elm_lang$core$Random$generate,
							_user$project$Main$ChangeColors,
							A2(_elm_lang$core$Random$list, 3, _user$project$Main$randomColor))
					};
				case 'NewImage':
					return {
						ctor: '_Tuple2',
						...
						_1: A2(
							_elm_lang$core$Random$generate,
							_user$project$Main$ChangeImage,
							_elm_community$random_extra$Random_Extra$sample(_user$project$Main$imageSet))
					};
				case 'ChangeColors':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tileGrid: A3(_user$project$Day14_TileGrid$changeColors, model.now, _p0._0, model.tileGrid)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ChangeImage':
					if (_p0._0.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{colorImage: _p0._0._0._0, silhouetteImage: _p0._0._0._1}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				case 'ColorImageLoaded':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$requestImageColors('mainImage')
					};
				default:
					var newColors = A2(
						_elm_lang$core$List$map,
						function (_p2) {
							var _p3 = _p2;
							return A3(_elm_lang$core$Color$rgb, _p3._0, _p3._1, _p3._2);
						},
						_p0._0);
					var _v2 = _user$project$Main$ChangeColors(newColors),
						_v3 = model;
					msg = _v2;
					model = _v3;
					continue update;
...
var _user$project$Main$NewColors = {ctor: 'NewColors'};
				...
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_user$project$Main$imageColorResults(_user$project$Main$AnalyzedColors),
							A2(_elm_lang$core$Time$every, 5000, _user$project$Main$NewImage)
						]));
			},
